...
return [
    ...
    "expiry_30_days"                          => "Expiring in 30 Days",
    "expiry_90_days"                          => "Expiring in 90 Days",
    "expiry_180_days"                         => "Expiring in 180 Days",
    ...
    "expiry_within_days"                      => "Items expiring within {0} days",
    "expiry_within_days_status"               => "Items expiring within {0} days ({1})",
    "expiry_within_days_label"                => "Expiry Threshold (Days)",
    "inventory_expiry"                        => "Inventory Expiry",
    "inventory_expiry_report"                 => "Inventory Expiry Report",
    ...
    "inventory_reorder"                      => "Reorder Report",
    "inventory_reorder_report"               => "Inventory Reorder Report",
    ...
    "reorder_item_count"                      => "Items to Reorder",
    "reorder_total_quantity"                  => "Total Reorder Quantity",
